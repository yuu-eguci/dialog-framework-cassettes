...
class Conf:
    ...
    cassette = 'cassette-matetrpg2scapegoat'
    # メインテキストの名前
    maintextName = 'matetrpg2罪の身代わり.txt'
    ...
    linkingList = [
        ...
        {'(山井みどり)': {'main':'chara_pl.png', 'back':'chara_pl_back.png'}},
    ]
